...
public class EX_String01 {
	...
	//SumMicroSystem(Oracle) 업체에서 미리 제작하여 제공 ▶ API(Library)
	...
	public static void main(String[] args) {
		...
		String str2 = new String("APPLE");	//APPLE 문자열을 str2 변수에 할당
		...
		//문자열에서 특정 문자 한글자만 출력 : charAt()
		System.out.println(str2.charAt(3));
		System.out.println(str2.substring(3, 4));
		
		//특정문자의 존재여부 : indexOf() ▶ 존재 : index 값을 반환, 실패 : -1
		 ...
		 System.out.println("공백 제거 전 문자열 길이 : "+str4.length());
		 System.out.println(str4.trim());
		 System.out.println("공백 제거 후 문자열 길이 : "+str4.trim().length());
	}//main()
}//class
