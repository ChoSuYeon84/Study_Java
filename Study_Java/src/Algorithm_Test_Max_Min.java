...
public class Algorithm_Test_Max_Min {
	...
	public static void main(String[] args) {
		...
		Algorithm_Test_Max_Min atmm= new Algorithm_Test_Max_Min();
		System.out.println("최대값 : "+atmm.maxMachine(arr));
		System.out.println("최소값 : "+atmm.minMachine(arr));
