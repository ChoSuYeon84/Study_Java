...
public class IO_EX02 {
	...
	public static void main(String[] args) {
		...
		try {
			int data = is.read();
			System.out.println(data);		//출력값 : 65
			System.out.println((char)data);	//출력값 : A
			
			data = is.read();
			System.out.println(data);		//출력값 : 13
			System.out.println((char)data);	//출력값 : 공백
			
			data = is.read();
			System.out.println(data);		//출력값 : 10
			System.out.println((char)data);	//출력값 : 공백
